...
public class HomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View o_view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ord_item,parent,false);
        View f_view = LayoutInflater.from(parent.getContext()).inflate(R.layout.foot_item,parent,false);
        int i;
        if (viewType == F_TYPE){
            return new RecyclerViewHolder(f_view,F_TYPE);
        }else{
            return new RecyclerViewHolder(o_view,N_TYPE);
        }
